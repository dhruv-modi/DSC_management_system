    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            else
            {
                ...
                try
                {
                    string sql = "CREATE TABLE 'transaction_master' ( `record_id` INTEGER PRIMARY KEY AUTOINCREMENT, `location_ref` varchar ( 50 ), `trans_date` datetime, `inward_date` datetime, `inward_by` INTEGER, `receive_mode` INTEGER, `activity_id` INTEGER, `dsc_uid` varchar ( 20 ), `dsc_model` varchar ( 30 ), `dsc_make` varchar ( 30 ), `dsc_colour` varchar ( 30 ), `inward_charge` INTEGER, `return_init` Integer ( 1 ), `autoreturn_date` datetime, `autoreturn_days` INTEGER, `outward_date` datetime, `outward_mode` varchar ( 30 ), `outward_by` INTEGER, `outward_charges` INTEGER, `outward_collected_by` varchar ( 20 ), `courier_name` varchar ( 30 ), `courier_track_id` varchar(30), `dsc_stayed` INTEGER, `record_open` INTEGER DEFAULT 1, `last_modified` datetime, `wrong_entry` INTEGER DEFAULT 0, `remarks1` varchar ( 100 ), `remarks2` varchar ( 100 ), `usr_char_1` varchar ( 10 ), `usr_char_2` varchar ( 20 ), `usr_char_3` varchar ( 50 ), `usr_int_1` INTEGER, `usr_int_2` INTEGER, `usr_int_3` INTEGER, `usr_dec_1` decimal, `usr_dec_2` decimal, `usr_dec_3` decimal, `usr_dt_1` datetime, `usr_dt_2` datetime, `usr_dt_3` datetime )";
