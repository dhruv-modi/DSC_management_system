        ...
        static void Main()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    sql = "CREATE TABLE `owner_master` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `owner_name` varchar ( 20 ), `address1` varchar ( 30 ), `address2` varchar ( 30 ), `address3` varchar ( 30 ), `city` varchar ( 30 ), `state` varchar ( 30 ), `country` varchar ( 30 ), `pincode` varchar ( 10 ), `sms_contact` varchar ( 12 ), `contact_name` varhcar ( 30 ), `whatsapp_contact` varchar ( 12 ), `telegram_contact` varchar ( 12 ), `email1` varchar ( 100 ), `email2` varchar ( 100 ), `owner_ref` varchar ( 50 ), `default_inward_mode` INTEGER, `default_outward_mode` INTEGER, `active` INTEGER DEFAULT 1, `usr_char_1` varchar ( 10 ), `usr_char_2` varchar ( 20 ), `usr_char_3` varchar ( 50 ), `usr_int_1` INTEGER, `usr_int_2` INTEGER, `usr_int_3` INTEGER, `usr_dec_1` decimal, `usr_dec_2` decimal, `usr_dec_3` decimal, `usr_dt_1` datetime, `usr_dt_2` datetime, `usr_dt_3` datetime );";
                    command.CommandText = sql;
                    command.ExecuteNonQuery();
